...
public class FriendsContractProvider extends ContentProvider {

    private FriendsContractDatabase mOpenHelper;
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        // content://com.itstep.restapi.providers.FriendsContractProvider/FRIENDS
        matcher.addURI(FriendsContract.CONTENT_AUTHORITY, FriendsContract.TABLE_NAME, FRIENDS);
        // content://com.itstep.restapi.providers.FriendsContractProvider/FRIENDS/8
    ...
    public boolean onCreate() {
        mOpenHelper = FriendsContractDatabase.getInstance(getContext());
        return true;
    }
